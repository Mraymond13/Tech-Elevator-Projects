...
public class UserSqlDAO implements UserDAO {
    ...
    @Override
    public boolean create(String username, String password, String role, String email_address) {
    ...
    @Override
	public void updateUserImage(int id, String user_image) {
		
    	String sql ="UPDATE users SET user_image = ? WHERE user_id = ?";
    	 jdbcTemplate.update(sql,user_image, id  );
